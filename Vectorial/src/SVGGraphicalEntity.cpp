...
//	this->convertSVG();
//	rasterized_ = false;
//	w_ = svgImage_->getWidth();
//	h_ = svgImage_->getHeight();
//	image_ = 0;
//}
//
...
//		do {
//			drawPolygon(screen, path->points, path->size, path->stroke,
//					path->fill);
//			path = path->next;
//		} while (path != NULL);
//	}
//	if (DEBUG) {
//		NSVGshape * shape;
//		for (unsigned int i = 0; i < svgImage_->getShapes().size(); i++) {
//			shape = svgImage_->getShapes()[i];
//			drawPath(screen, shape->paths, 0, 0);
//		}
//	}
//}
//
